      ...
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex items-center gap-4">
          <a href="tel:0112588846" className="flex items-center gap-1.5 hover:text-gold transition-colors">
            ...
            <span>(011) 258 8846</span>
          </a>
          <span className="text-background/30">|</span>
          <a href="mailto:info@mulaudziattorneys.co.za" className="flex items-center gap-1.5 hover:text-gold transition-colors">
            <Mail className="w-3.5 h-3.5" />
            <span>info@mulaudziattorneys.co.za</span>
          </a>
          <span className="text-background/30">|</span>
          <div className="flex items-center gap-1.5 hover:text-gold transition-colors">
            <MapPin className="w-3.5 h-3.5" />
            <span>21 Woodlands Drive, Woodmead, 2191</span>
          </div>
        </div>
